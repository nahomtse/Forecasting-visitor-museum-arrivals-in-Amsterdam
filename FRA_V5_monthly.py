...
df = pd.read_excel('/Users/nahomtsehaie/documents/21069_attractiesnahom.xlsx', sheet_name = 'Rembrandhuis' , )
...
plt.xlabel ('date')
plt.legend(loc='best')
plt.title("Traindand Test data Rembrandthuis 2016-2020 ")
plt.show()
...
plt.ylabel('amount of visitors')
plt.xlabel ('date')
plt.title("Naive Forecast Monthly Rembrandthuis")
plt.show()
...
plt.ylabel('amount of visitors')
plt.xlabel ('date')
plt.title("Simple Exponential Smoothing  Monthly Rembrandthuis")
plt.show()
...
#y_hat_avg = test.copy()
fit12 = Holt(np.asarray(train['Count'])).fit(smoothing_level = 0.2,smoothing_trend = 0.2 , optimized= True)
...
plt.ylabel('amount of visitors')
plt.xlabel ('date')
plt.title("Holt's Linear Trend method Monthly Rembrandthuis")
plt.show() 
...
plt.ylabel('amount of visitors')
plt.xlabel ('date')
plt.title("Holt Winter's Exponential Smoothing Monthly Rembrandthuis")
plt.show()
...
#y_hat_avg = test.copy()
model = ARIMA(train['Count'], order=(2, 0, 2))
model_fit = model.fit()
...
plt.ylabel('amount of visitors')
plt.xlabel ('date')
plt.title("ARMA Monthly Rembrandthuis")
plt.show()
...
#y_hat_avg = test.copy()
model = ARIMA(train['Count'], order=(2, 1, 0))
model_fit = model.fit()
#print(model_fit.summary())
...
plt.ylabel('amount of visitors')
plt.xlabel ('date')
plt.title("ARIMA Monthly Rembrandthuis")
plt.show()
...
#y_hat_avg = test.copy()
model = SARIMAX(train['Count'], order=(2, 0, 2), seasonal_order=(2,0,2,12))
...
plt.ylabel('amount of visitors')
plt.xlabel ('date')
plt.title("SARIMA Monthly Rembrandthuis")
plt.show()
